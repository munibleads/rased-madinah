...
export default function ProjectsPageClient({ initialLang }: ProjectsPageClientProps) {
  const [currentLang, setCurrentLang] = React.useState<"en" | "ar">(initialLang)
              ...
              <div className="px-6 lg:px-8">
                <div className="flex flex-col gap-2">
                  ...
                  <p className="text-muted-foreground text-lg">
                    {currentLang === "ar"
                      ? "إدارة وتتبع جميع مشاريع البناء والتطوير الخاصة بك"
                      : "Manage and track all your construction and development projects"}
                  </p>
                </div>
              </div>
