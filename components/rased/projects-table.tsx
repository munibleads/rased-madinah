...
const projectsData = [
  ...
  {
    id: "PRJ-003",
    name: "Jubail Industrial Zone Expansion",
    nameAr: "توسعة المنطقة الصناعية في الجبيل",
    type: "Industrial",
    typeAr: "صناعي",
    status: "Review",
    statusAr: "مراجعة",
  ...
  {
    id: "PRJ-004",
    name: "Dammam Port Infrastructure",
    nameAr: "بنية ميناء الدمام التحتية",
    type: "Infrastructure",
    typeAr: "بنية تحتية",
    status: "In Progress",
    statusAr: "قيد التنفيذ",
  ...
  {
    id: "PRJ-005",
    name: "Taif Mountain Resort",
    nameAr: "منتجع جبال الطائف",
    type: "Commercial",
    typeAr: "تجاري",
    status: "Completed",
    statusAr: "مكتمل",
  ...
  {
    id: "PRJ-006",
    name: "Al-Khobar Waterfront Development",
    nameAr: "تطوير الواجهة البحرية للخبر",
    type: "Environmental",
    typeAr: "بيئي",
    status: "Planning",
    statusAr: "التخطيط",
